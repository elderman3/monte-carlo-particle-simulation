...
__host__ __device__ array<double,3> add3(const array<double,3>& a,const array<double,3>& b) {return{a[0]+b[0],a[1]+b[1],a[2]+b[2]};}
...
__host__ __device__ array<double,3> normed(const array<double,3>& v) {
